...
import hu.bme.mit.thesis.transformation.transformation.BatchModelTransformation;
...
public class ApplicationStarter {
	...
	public Integer start(final String[] arguments) {
            if(arguments.length == 2) {
            	String papyrusLocation = arguments[0];
            	String autosarLocation = arguments[1];
                readPapyrusModel(papyrusLocation);
                runTransform();
                createArxmlFileWithSave(autosarLocation);
            }
            else {
	...
	private void readPapyrusModel(String umlFileUri) {
		...
		URI inputModelFile = URI.createFileURI("C:/Users/KoczkaP/workspace-papyrus/Szakdolgozat/Szakdolgozat.uml");
	...
	private void createArxmlFileWithSave(String autosarFileUri) {
		...
		URI outputModelFile = URI.createFileURI("C:/Users/KoczkaP/Documents/Artop/workspace/Szakdolgozat/outputModel.arxml");
